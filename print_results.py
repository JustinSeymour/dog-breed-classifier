...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("{:20}: {:3d}".format('N Not-a-Dog Images: ', results_stats_dic['n_correct_notdogs']))


    # Prints summary statistics (percentages) on Model Run
    print("\n\n*** Precentage Summary for Percentages CNN Model Architecture",model.upper(), 
          "***")
